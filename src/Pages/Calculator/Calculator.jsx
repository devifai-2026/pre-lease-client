...
const Calculator = () => {
  ...
  return (
    <div className="font-montserrat">
      ...
      <div 
        className="absolute top-0 left-0 right-0 h-[400px] sm:h-[450px] -z-10"
        style={{
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between w-full">
          {/* left content */}
          <div className="flex-1 ml-0 sm:ml-14 space-y-4 sm:space-y-6 px-4 sm:px-0">
            <div className="flex items-center gap-3 justify-center sm:justify-start">
              <FaCalculator className="bg-[#EE2529] rounded-lg p-2 w-12 h-12 sm:w-16 sm:h-16 text-white" />

              <div>
                <p className="bg-[#FFF3CA] py-1 px-2 rounded-3xl text-[#767676] text-xs sm:text-sm w-fit whitespace-nowrap">
                  Professional Investment Tools
                </p>
                <p className="text-[#262626] font-bold text-lg sm:text-2xl text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 justify-center sm:justify-start">
              ...
              <div className="shadow-md rounded-md p-3 sm:p-4 space-y-1 sm:space-y-2 w-full sm:w-[160px] text-center bg-white">
                ...
                <p className="text-[#EE2529] text-sm sm:text-base">
      ...
      {/* Calculator Sections */}
      <div className="relative shadow-md rounded-lg p-2 flex flex-col sm:flex-row items-center justify-around max-w-[92%] mx-auto mt-8">
        {/* ROI Calculator - Default Active */}
        <div
          className="cursor-pointer relative p-2 w-full sm:w-auto text-center sm:text-left"
        ...
        >
          ...
          {activeSection === "roi" && (
            <div className="absolute -bottom-2 left-0 right-0 h-[4px] bg-[#EE2529] hidden sm:block"></div>
          )}
        </div>
        ...
        {/* Mobile Separator */}
        <div className="w-full h-px bg-gray-300 my-2 sm:hidden"></div>
      ...
      <div className="mt-6 sm:mt-8 max-w-[95%] mx-auto px-2 sm:px-0">
