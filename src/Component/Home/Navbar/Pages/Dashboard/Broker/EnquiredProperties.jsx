...
const EnquiredProperties = () => {
  ...
  // Enquired properties data with Unsplash images
  const enquiredProperties = [
    {
      id: 1,
    ...
    <div className="font-montserrat">
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row space-y-2 items-center justify-between mb-6">
          <h1 className="text-base md:text-lg lg:text-xl font-bold text-[#EE2529]">Enquired Properties</h1>
                    ...
                    {property.id === 1 ? (
                      ...
                      <>
                        ...
                        <button 
                          ...
                          className="flex-1 border rounded-md text-white px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-[#EE2529] to-[#C73834] text-xs sm:text-sm hover:opacity-90 transition-opacity hover:scale-105 font-semibold"
                        >
                          Enquire
                        </button>
                      </>
            ...
            <table className="w-full text-xs sm:text-sm">
              <thead>
                <tr className="border-b border-[#E0E0E0]">
                  ...
                  <th className="text-left py-3 px-2 font-semibold text-[#262626]">Enquiry Status</th>
                  ...
                  return (
                    <tr key={property.id} className="border-b border-[#E0E0E0]">
                      ...
                      <td className="py-3 px-2">
                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusBadgeColor(property.enquiryStatus)}`}>
