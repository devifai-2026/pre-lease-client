...
const MyPortfolio = () => {
  ...
  // State for view mode and dropdowns
  ...
  const propertyCards = [
    ...
    },
    {
      ...
      images: [
        ...
        "https://images.unsplash.com/photo-1487956382158-bb926046304a?w=500&h=400&fit=crop"
      ],
    },
  ];
  ...
  const handleCompareClick = (propertyId, propertyTitle) => {
    setSelectedProperties((prev) => {
      ...
      if (isAlreadySelected) {
        ...
        // Add to selection (limit to 3 properties for comparison) - CHANGED FROM 4
        if (prev.length < 3) {
          const property = propertyCards.find(p => p.id === propertyId);
          return [...prev, { 
            id: propertyId, 
  ...
  return (
    <div className="min-h-screen font-montserrat">
      ...
      {selectedProperties.length > 0 && (
        <div className="sticky top-20 z-40 bg-white shadow-lg border-b border-gray-200 mb-6">
          <div className="mx-auto font-montserrat max-w-[90%]">
            ...
            {/* Selected Properties Grid - Updated for max 3 properties */}
            <div className="py-3">
              <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
                {/* Selected Property Cards Container - Now shows 3 max */}
      ...
      <h3 className="text-xl font-semibold text-[#262626] mb-8 text-center">
        Portfolio Diversification
      </h3>
        ...
        {diversificationData.map((item, index) => (
          <div key={index} className="flex items-center gap-2">
            ...
            <span className="text-sm text-[#767676]">
              {item.name} <span style={{ color: item.color, fontWeight: '500' }}>{item.value}%</span>
            </span>
          </div>
        ))}
      </div>
    ...
    >
      ...
      <Legend
        ...
        formatter={(value, entry) => {
          ...
          return (
            <span style={{ color: color,  fontSize: "18px", textAlign: "center" }}>
              {value}
            </span>
          );
        }}
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row space-y-2 justify-between items-center mb-4">
          ...
          <div className="flex flex-row gap-2 sm:gap-3 items-center">
            ...
            {/* Show as section with dropdown */}
            <div className="relative">
              <button
                className="flex items-center gap-2 text-sm hover:bg-gray-50 whitespace-nowrap px-2 py-1"
